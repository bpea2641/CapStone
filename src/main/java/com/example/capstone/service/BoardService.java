...
import com.example.capstone.repository.BoardFileRepository;
    ...
    public BoardDTO update(BoardDTO boardDTO) throws IOException {
        ...
        if(boardEntityOptional.isPresent()){
            ...
            if (boardDTO.getFileAttached() == 1) {
                ...
                System.out.println("update - notAttectd");
                boardEntity.setFileAttached(boardDTO.getFileAttached());
                // 기존 파일 삭제
                if(boardEntity.getBoardFileEntityList().size()>0){
                    boardFileRepository.deleteById(boardEntity.getBoardFileEntityList().get(0).getId());
                }
...
//            String savePath = "/Users/사용자이름/springboot_img/" + storedFileName; // C:/springboot_img/9802398403948_내사진.jpg
            ...
            updateDTO = BoardDTO.toBoardDTO(boardEntity);
        }
        return updateDTO;
    }
